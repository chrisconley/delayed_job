...
* Use <code>heroku config:add</code> to add these 3 keys: <code>HEROKU_USERNAME, HEROKU_PASSWORD, HEROKU_APP_NAME</code>.  These are used to launch the heroku client from your dyno in order to change the worker quantity.
...
Many thanks to pedro for this awesome feature!
